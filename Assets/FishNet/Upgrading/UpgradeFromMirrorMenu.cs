...
namespace FishNet.Upgrading.Mirror.Editing
{
    ...
    * then remove it after running this script. */
    ...
    public class UpgradeFromMirrorMenu : MonoBehaviour
    {
        ...
        {
            string currentDefines = UnityEditor.PlayerSettings.GetScriptingDefineSymbolsForGroup(EditorUserBuildSettings.selectedBuildTargetGroup);
            ...
            if (removed)
            {
                ...
                UnityEditor.PlayerSettings.SetScriptingDefineSymbolsForGroup(EditorUserBuildSettings.selectedBuildTargetGroup, changedDefines);
            }
        }
